...
3) The savePostInfo is the common function between both of the above ways - it determines what should be recorded in the database
...
var newReq;
var initialMonitorTimeInterval = 10000; // in milliseconds for setInterval
var postDay1TimeInterval = 15000; // in milliseconds for setInterval
...
connect()
  ...
  .use(function(req, res, next) {
    ...
    try {
        ...
        console.log("setIntervalSynchronous, recordNewPosts function: "+err.message);
    }
    try {
        ...
        console.log("setIntervalSynchronous, getAllTrackedPosts function : "+err.message);
    }
...
function recordNewPosts() {
  ...
  newReq.facebook.api('', 'POST', {
      ...
      console.log("recordNewPosts function : "+err.message);
  }
}
  ...
  try {
    var parsedObj = returnParsedObject (postObj);
        ...
        writeDB(query2, queryParameters2);
          ...
          console.log("savePostInfo function : "+err.message);
      }
}
...
function getPages() {
  try {
    newReq.facebook.api('/', 'GET', {ids: '146505212039213,199098633470668,179417642100354,363765800431935,21785951839,334191996715482',
      ...
      console.log("getPages function : "+err.message);
  }
}
...
function sendEmail (postObj) {
  ...
  var emailData = [];
    ...
    transporter.sendMail(mailOptions, function(error, info){
      ...
      console.log("sendEmail function : "+err.message);
  }
}
...
function checkIfNewPost(query, postObj, callback, pageName) {
  ...
  con.query(query, function (err, result) {
      ...
      console.log("checkIfNewPost function : "+err.message);
  }
}
...
function getAllTrackedPosts(callback) {
  ...
  con.query('SELECT postId, createdTime, trackingStatus, pageName FROM activePostsMetaData', function (err, result) {
    //  console.log(result[0][Object.keys(result[0])[0]]);
      ...
      console.log("getAllTrackedPosts function : "+err.message);
  }
}
...
function updateExistingPosts(trackedPostsArray, i) {
  ...
  // console.log(i);
    newReq.facebook.api('', 'POST', {
        ...
        console.log("updateExistingPosts function : "+err.message);
    }
}
...
function writeDB (query, queryParameters) {
  ...
  con.query(query, queryParameters, function (err, result) {
    ...
    // console.log("1 record inserted");
      ...
      console.log("writeDB function : "+err.message);
  }
}
...
function returnParsedObject (postObj) {
  ...
  if (postObj !=undefined) {
    ...
    parsedObj.id = "146505212039213_2821344734555234"; //just a sample valid ID just in case to prevent getting an error
    parsedObj.link=null;
  ...
  return parsedObj;
        ...
        console.log("returnParsedObject function : "+err.message);
    }
}
...
var setIntervalSynchronous = function (func, delay) {
  ...
  return clear;
      ...
      console.log("setIntervalSynchronous function : "+err.message);
  }
};
